...
const PendingPlaces = () => {
    ...
    const fetchPendingPlaces = async () => {
      try {
        ...
        const response = await axios.get(
          `${process.env.BASE_URL}/api/admin/places/pending`,
          {
            headers: {
  ...
  const handleApprove = async (placeId) => {
    try {
      ...
      await axios.put(
        `${process.env.BASE_URL}/api/admin/places/${placeId}/approve`,
        {},
        {
          headers: {
            Authorization: `Bearer ${token}`,
  ...
  const handleReject = async () => {
    ...
    try {
      ...
      await axios.put(
        `${process.env.BASE_URL}/api/admin/places/${selectedPlace._id}/reject`,
        { rejectionReason },
        {
          headers: {
            Authorization: `Bearer ${token}`,
