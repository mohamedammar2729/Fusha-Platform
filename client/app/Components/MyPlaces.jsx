...
const MyPlaces = () => {
      ...
      try {
        ...
        try {
          const response = await axios.get(
            `${process.env.BASE_URL}/api/seller-places/my-places`,
            {
              headers: {
  ...
  const handleViewDetails = async (placeId) => {
    try {
      ...
      try {
        const response = await axios.get(
          `${process.env.BASE_URL}/api/seller-places/my-places/${placeId}/details`,
          {
            headers: {
              Authorization: `Bearer ${token}`,
            },
  ...
  const handleViewStatistics = async (placeId) => {
    try {
      ...
      try {
        const response = await axios.get(
          `${process.env.BASE_URL}/api/seller-places/my-places/${placeId}/statistics`,
          {
            headers: {
              Authorization: `Bearer ${token}`,
            },
