...
const NavBar = () => {
  ...
  // Update the handleDarkModeToggle function to handle the toggle source
  const handleDarkModeToggle = useCallback((source = "desktop") => {
    setDarkMode((prev) => {
      const newMode = !prev;

      const darkModeToggle = document.getElementById("input");
      const mobileDarkModeToggle = document.getElementById("input-mobile");

      if (darkModeToggle) darkModeToggle.checked = newMode;
      if (mobileDarkModeToggle) mobileDarkModeToggle.checked = newMode;
      ...
      >
                ...
                <DarkmodeButton>
                  <label className="switch">
                    <input
                      id="input"
                      type="checkbox"
                      onChange={() => handleDarkModeToggle("desktop")}
                    />
        ...
        <Box
          sx={{
            ...
            flexDirection: "row-reverse",
            order: { xs: 2, md: 1 }, // Lower order value positions it more to the left
          }}
        >
          <Box
            sx={{
              display: "flex", // Always display this Box
              alignItems: "center",
              flexGrow: 0,
              gap: 2,
              flexDirection: "row-reverse",
