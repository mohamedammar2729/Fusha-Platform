    ...
    <NavBarWrapper position="Sticky">
      ...
      >
        ...
        >
          ...
          {!user && [
            // Render the MenuItems directly without Fragment wrapper
        ...
        >
          ...
          >
            <Link href="/profile" passHref legacyBehavior>
              <MemoizedNavItem sx={{ textDecoration: "none", fontWeight: 550 }}>
                بروفايل
              </MemoizedNavItem>
            </Link>
          </MenuItem>
        ...
        <DarkmodeButton sx={{ display: { xs: "none !important", md: "flex" } }}>
